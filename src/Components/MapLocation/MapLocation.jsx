...
const MapLocation = () => {
  return (
    <div className="grid grid-cols-12 gap-8 py-10 max-md:py-5">
      <div className="col-span-6 max-md:col-span-12">
        ...
        <p className="h3 pl-2">
          <span className="font-bold">Address: </span> Flat no 1 sukhanand
          polyclinic jagtap chowk, Maharashtra 411040
        </p>

        <p className="h3 pl-2">
          <span className="font-bold"> Contact No: </span>
          <span>91+9762210989</span>
        </p>
      </div>
